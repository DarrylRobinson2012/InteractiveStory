...
//  InteractiveStory
//
//  Created by Darryl Robinson  on 3/6/18.
...
class ViewController: UIViewController {
    ...
    @IBOutlet weak var textFieldBottomContriant: NSLayoutConstraint!
        ...
        if segue.identifier == "startAdventure" {
            ...
            do {
                if let name = nameTextFeild.text {
                    if name == "" {
                        throw AdevntureError.nameNotProvided
                    }else {
            ...
            catch AdevntureError.nameNotProvided {
    ...
    @objc func keyboardwillHide(_ notifcaation: Notification){
        textFieldBottomContriant.constant = 40
    ...
    @objc func keyboardWillShow(_ notification: Notification) {
        if let info = notification.userInfo, let keyboardFrame = info [UIKeyboardFrameEndUserInfoKey] as? NSValue {
            ...
            textFieldBottomContriant.constant = frame.size.height+10
